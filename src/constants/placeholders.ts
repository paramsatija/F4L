...
export const TICKET_TIERS = [
  {
    ...
    currency: 'AED',
    features: [
      'Front row runway seating',
      'Private meet & greet with Jacob Meir',
      'Museum Collection private viewing',
      'VIP gift bag worth AED 5,000+',
      'Exclusive after-party access',
      'Commemorative event book (signed)',
      'Professional photos delivered',
      'Dedicated concierge',
    ],
    highlight: true,
  },
  {
    ...
    currency: 'AED',
    features: [
      'Premium runway seating (rows 2-5)',
      'Champagne reception access',
      'Museum Collection access',
      'Gift bag worth AED 2,500',
      'After-party access',
      'Event program',
    ],
    highlight: false,
